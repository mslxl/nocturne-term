    ...
    workspaces: [
      {
        ...
        layout: {
          ...
          ratios: [0.28, 0.72],
          children: [
            createDockGroup("group-files", [createOwnedSlot("slot-files", "tool-files")], "slot-files"),
            {
              kind: "split",
              direction: "column",
              ratios: [0.78, 0.22],
              children: [
                createDockGroup("group-terminal", [createOwnedSlot("slot-terminal", "tool-terminal")], "slot-terminal"),
                createDockGroup("group-transfers", [createOwnedSlot("slot-transfers", "tool-transfers")], "slot-transfers"),
              ],
            },
          ],
        },
